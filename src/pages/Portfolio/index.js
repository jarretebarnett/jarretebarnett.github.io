            ...
            <span id="slider" className="badge bg-black">
                <div id="carouselControls" className="carousel slide carousel-fade" data-ride="carousel">
                    ...
                    <div className="carousel-inner">
                        ...
                        <div className="carousel-item active">
                            <a href="https://bookapigoogle.herokuapp.com/" rel="noreferrer" target="_blank"><img className="d-block w-100" src={googlebooks} alt="First slide"/></a>
                            <div className="carousel-caption d-none d-md-block">
                        ...
                        <div className="carousel-item">
                            <a href="https://jarretebarnett.github.io/reactportfolio/" rel="noreferrer" target="_blank"><img className="d-block w-100" src={betaportfolio} alt="Second slide"/></a>
                            <div className="carousel-caption d-none d-md-block">
                        ...
                        <div className="carousel-item">
                            <a href="https://seanmonaghan.github.io/LyriChord/" rel="noreferrer" target="_blank"><img className="d-block w-100" src={lyrichord} alt="Third slide"/></a>
                            <div className="carousel-caption d-none d-md-block">
                        ...
                        <div className="carousel-item">
                            <a href="https://jarretebarnett.github.io/weatherdashboard/" rel="noreferrer" target="_blank"><img className="d-block w-100" src={weatherdash} alt="Fourth slide"/></a>
                            <div className="carousel-caption d-none d-md-block">
